...
/**
 * Nombre del modulo: ASIGNACION DE INSUMOS
 * Desarrollador:Ing. Ivan Acosta
 * Fecha de elaboraciòn:
 * Tablas SQL:
 * tbl_RelSucursalInsumosA-Tabla relacional donde se almacenan el ID tanto de la sucursal como de los isumos y el area asignada. 
 * cat_CEDInsumos:Catalogo del cual obtenemos la infomacion de los insumos. 
 */
